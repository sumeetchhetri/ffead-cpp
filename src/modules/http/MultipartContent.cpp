...
MultipartContent::MultipartContent(const string& content)
{
	setContent(content);
}

MultipartContent::MultipartContent(const vector<string>& headers, const string& content)
{
	setContent(content);
	if(headers.size()!=0)
	{
...
void MultipartContent::setContent(const string& content) {
...
void MultipartContent::setFileName(const string& fileName) {
...
void MultipartContent::setTempFileName(const string& tempFileName) {
	this->tempFileName = tempFileName;
}

void MultipartContent::addHeaderValue(string header, const string& value)
{
...
bool MultipartContent::isHeaderValue(string header, const string& value, const bool& ignoreCase)
{
	header = StringUtil::camelCasedCopy(header, "-");
...
void MultipartContent::setName(const string& name) {
	this->name = name;
}

string MultipartContent::getHeader(const string& header)
{
