...
enum SERVER_BACKEND {
	...
	JS_NODEJS, JS_DENO, //Nodejs and Deno [27, 28]
	C_QUICHE_HTTP3, //Quiche http3 [29]
	SEASTAR, //Seastar framework [30]
	JULIA_HTTP, //Julia http server [31]
	MONGOLS, CPPSERVER, UV_CPP //Mongols, Cppserver, uv-cpp [32, 33, 34]
};
