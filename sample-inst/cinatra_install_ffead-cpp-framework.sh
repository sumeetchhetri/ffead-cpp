...
cmake -DCINATRA_INCLUDES="/root/cinatra/include" -DSRV_CINATRA=on -DDEBUG=on -DMOD_APACHE=off -DMOD_NGINX=off -DMOD_MEMCACHED=on -DMOD_REDIS=on -DMOD_SDORM_MONGO=on .
