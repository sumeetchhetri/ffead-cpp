...
docker rmi -f sumeetchhetri/ffead-cpp-v4.0-rust-rocket-base:1.0
docker build -f ffead-cpp-rust-rocket-base.dockerfile -t sumeetchhetri/ffead-cpp-v4.0-rust-rocket-base:1.0 .
docker push sumeetchhetri/ffead-cpp-v4.0-rust-rocket-base:1.0
