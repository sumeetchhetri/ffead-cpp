...
RUN wget -q https://github.com/crystal-lang/crystal/releases/download/0.27.0/crystal-0.27.0-1-linux-x86_64.tar.gz \
	&& tar --strip-components=1 -xzf crystal-0.27.0-1-linux-x86_64.tar.gz -C /usr/ && rm -f *.tar.gz
