...
cd ${IROOT}/ffead-cpp-src/
cp -rf ffead-cpp-6.0-bin ${IROOT}/ffead-cpp-6.0-picoev
rm -rf ffead-cpp-6.0-bin

cd ${IROOT}/ffead-cpp-6.0-picoev
...
cd ${IROOT}/ffead-cpp-src/
cp -rf ffead-cpp-6.0-bin ${IROOT}/ffead-cpp-6.0-io_uring
rm -rf ffead-cpp-6.0-bin

cd ${IROOT}/ffead-cpp-6.0-io_uring
