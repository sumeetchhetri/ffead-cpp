...
cmake -DSRV_EMB=on -DMOD_APACHE=on -DMOD_NGINX=on -DMOD_MEMCACHED=on -DMOD_REDIS=on -DMOD_SDORM_MONGO=on -DPostgreSQL_TYPE_INCLUDE_DIR="/usr/include/postgresql" .
